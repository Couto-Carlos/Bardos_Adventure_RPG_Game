...
public class PermissionActivity extends AppCompatActivity implements PermissionRationalDialogFragment.DialogListener {
    ...
    private void requestPermissions() {
        ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.RECORD_AUDIO, Manifest.permission.BLUETOOTH, Manifest.permission.BLUETOOTH_ADMIN},  RECORD_AUDIO_PERMISSION_REQUEST_CODE);
    }

    private void onPermissionGranted() {
        // Go to the Guitar Tuner Activity
        startActivity(BluetoothActivity.newIntent(PermissionActivity.this));
        finish();
    }
